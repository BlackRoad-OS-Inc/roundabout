...
- Deploy roundabout to Anastasia (DO nyc1) with systemd auto-start
...
- Add NLP intent routing: 'vpn status' / 'add node'
- Create RoundAbout Agent persona with RoundTrip auto-chat
- Integrate with RoadMem for persistent state across restarts
- Add Codex solution entries for common roundabout operations
- Build blackroad-operator CLI commands: `br roundabout status|deploy|logs`
...
- Contribute BlackRoad improvements back to upstream Headscale
